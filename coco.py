...
ROOT_DIR = os.path.abspath("/Users/shivamacpro/Desktop/EducationandProjects/StanfordSCPD/CS230/TermProject/Github/Mask_RCNN-master")
...
class CocoConfig(Config):
    ...
    NAME = "coco-coco+RN101+ES+LRP+LR:"+str(LEARNING_RATE)
...
class CocoDataset(utils.Dataset):
    with tf.device('/gpu:0'):
        def load_coco(self, dataset_dir, subset, year=DEFAULT_DATASET_YEAR, class_ids=None,
            ...
            class_listO("{}/annotations/instances_{}{}.json".format(dataset_dir, subset, year))
